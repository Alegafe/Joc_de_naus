...
def mostrar_menu():
    ...
    imprimir_pantalla_fons('assets/Fondo Menu.png')
    font1 = pygame.font.SysFont(None, 100)
    font2 = pygame.font.SysFont(None, 80)
    img1 = font1.render("Aleja Space!", True, MAGENTA)
    img2 = font2.render("1. Començar partida", True, GREEN)
    img3 = font2.render("2. Veure Crèdits", True, GREEN)
...
def mostrar_credits():
    ...
    img6 = font3.render("Alejandro Garcia:", True, BLUE)
...
while True:
    ...
    # Mostrar Pantalla de Game Over:
        ...
        imprimir_pantalla_fons('assets/Fondo Game Over.png')
